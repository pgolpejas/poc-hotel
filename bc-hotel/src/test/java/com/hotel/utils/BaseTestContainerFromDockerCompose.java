...
// Old way to use testcontainers with docker-compose
...
public abstract class BaseTestContainerFromDockerCompose {
	...
	public static final String POSTGRES_SERVICE_NAME = "hotel-db-it";
	...
	private static void startCompose() {
		...
		compose.waitingFor(SCHEMA_REGISTRY_SERVICE_NAME,
	...
	private static void printLogs() {
		...
		final Slf4jLogConsumer consumer = new Slf4jLogConsumer(
				LoggerFactory.getLogger(BaseTestContainerFromDockerCompose.class));
	...
	private static Map<String, Integer> prepareCompose() {
		...
		final Map<String, Object> composeContent = new Yaml()
				.load(ClassLoader.getSystemResourceAsStream("compose/docker-compose.yml"));
