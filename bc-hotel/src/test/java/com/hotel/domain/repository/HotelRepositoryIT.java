...
class HotelRepositoryIT extends BaseTestContainerFromDockerCompose {
  ...
  class Create {
    ...
    void when_hotel_is_ok_should_create_it() {
      ...
      Optional<Hotel> optSearch = hotelRepository.findById(hotelId);
      ...
      Assertions.assertThat(optSearch.get().id().toString()).as("aggregateId").hasToString(hotel.getAggregateId());
  ...
  class Search {
    ...
    void when_hotel_filter_with_selection_should_return_it() {
      ...
      final PaginationResponse<Hotel> pageResponse = hotelRepository.searchBySelection(criteria);
      ...
      Assertions.assertThat(pageResponse.data().getFirst().getAggregateId()).as("aggregateId").hasToString(hotelId);
    ...
    void when_hotel_filter_should_return_it() {
      ...
      final PaginationResponse<Hotel> pageResponse = hotelRepository.search(criteria);
  ...
  class SearchAudit {
    ...
    void when_hotel_created_javers_audited_it_and_return_shadows() {
      ...
      final Hotel hotelUpdate = Hotel.builder().id(id)
          .name("Hotel1")
          .address("Address1")
          .city("City11")
          .state("State1")
      ...
      final Hotel hotelUpdate2 = Hotel.builder().id(id)
          .name("Hotel14")
          .address("Address14")
          .city("City114")
          .state("State14")
          ...
          .postalCode("1234541")
          .build();
      hotelRepository.save(hotelUpdate2);
      ...
      final AuditFilters filters = AuditFilters.builder()
          ...
          .build();
      final List<Hotel> plannedProductList = HotelRepositoryIT.this.hotelRepository.findAuditByFilters(filters, 10);
