...
public class RoomUpdatedOutboxMapper implements OutboxEntityMapper<RoomUpdatedEvent> {

  private final RoomEventMapper eventMapper;

  @Override
  public OutboxKafkaMessage map(final RoomUpdatedEvent domainEvent) {
    final RoomUpdated outboxEvent = this.eventMapper.mapRoomUpdated(domainEvent);
