...
public class Hotel extends AggregateRoot implements Serializable {
    ...
    public Hotel(@NotNull final UUID id,
                 ...
                 @NotBlank
                 @Size(max = 200) final String address,
                 @NotBlank
                 @Size(max = 100) final String city,
                 @NotBlank
                 @Size(max = 100) final String state,
                 @NotBlank
                 @Size(max = 100) final String country,
                 @NotBlank
                 @Size(max = 10) final String postalCode) {
