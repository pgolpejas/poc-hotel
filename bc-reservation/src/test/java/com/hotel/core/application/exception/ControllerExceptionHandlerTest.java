    ...
    class OtherExceptions {
        ...
        void when_capture_DomainError_should_return_error() {
            ...
            final ResponseEntity<ProblemDetail> response =
                    ControllerExceptionHandlerTest.this.controllerExceptionHandler.handleDomainError(ControllerExceptionHandlerTest.this.request, new DomainError(detail));
        ...
        void when_capture_ConflictException_should_return_error() {
            ...
            final ResponseEntity<ProblemDetail> response =
                    ControllerExceptionHandlerTest.this.controllerExceptionHandler.handleConflictException(ControllerExceptionHandlerTest.this.request, new ReservationConflictException(detail) {
                    });
        ...
        void when_capture_NotFound_should_return_error() {
            ...
            final ResponseEntity<ProblemDetail> response =
                    ControllerExceptionHandlerTest.this.controllerExceptionHandler.handleNotFoundException(ControllerExceptionHandlerTest.this.request, new ReservationNotFoundException(detail));
        ...
        void when_capture_ConversionFailedException_should_return_error() throws NoSuchMethodException {
            ...
            final ResponseEntity<ProblemDetail> response =
                    ControllerExceptionHandlerTest.this.controllerExceptionHandler.handleConversionFailedException(ControllerExceptionHandlerTest.this.request, exception);
        ...
        void when_capture_invalid_format_exception_should_return_error() {
            ...
            final ResponseEntity<ProblemDetail> response =
                    ControllerExceptionHandlerTest.this.controllerExceptionHandler.handleInvalidFormatException(ControllerExceptionHandlerTest.this.request, mockException);
