...
public class ReservationController implements ReservationApi {
	...
	public ResponseEntity<ReservationDto> createReservation(ReservationDto reservationDto) {
		this.createReservationUseCase.createReservation(this.reservationMapper.mapToAggregate(reservationDto));
	...
	public ResponseEntity<ReservationPaginationResponse> searchReservation(
		...
		final PaginationResponse<Reservation> search = this.getReservationsUseCase
				.getReservations(this.criteriaMapper.mapToAggregate(criteriaRequestDto));
	...
	public ResponseEntity<ReservationListResponse> searchAuditReservation(Integer limit,
		...
		final List<ReservationDto> search = this.getReservationsAuditUseCase
				.getReservationsAudit(AuditFilters.builder().id(auditFilters.getId()).from(auditFilters.getFrom())
						.to(auditFilters.getTo()).build(), limit)
	...
	public ResponseEntity<ReservationDto> updateReservation(ReservationDto reservationDto) {
		this.updateReservationUseCase.updateReservation(this.reservationMapper.mapToAggregate(reservationDto));
