...
public class GetRoomTypeInventoryQueryHandler implements GetRoomTypeInventoryQuery {
	...
	public RoomTypeInventory getRoomTypeInventory(final UUID id) {
		return this.repository.findById(id).orElseThrow(
				() -> new RoomTypeInventoryNotFoundException("RoomTypeInventory with id %s not found", id));
	}
}
